...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		botonJugar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(player1.isNumeric(CuadroParaEdad.getText())==true)
					...
					player1.setEdad(999);
		//Al pulsar el boton mostrara el resultado por el cuadroParaMostrarJugador
		if (player1.getEdad()==999)
			...
			CuadroParaMostrarJugador.setText("Nuevo Jugador: "+player1.getNombre()+" "+player1.getPrimerApellido()+" "+player1.getSegundoApellido()+" de "+player1.getEdad()+" años");
	}
});
